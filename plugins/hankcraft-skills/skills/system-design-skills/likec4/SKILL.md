---
name: likec4
description: Use when working with `.c4`/`.likec4` files, LikeC4 CLI/config questions, or turning a system design into concrete C4/LikeC4 diagrams. Covers exact DSL/CLI syntax, validate/export flags, predicates `*`/`_`/`**`, deployment snippets, dynamic views, relationship extension matching, and model/view selection for landscape, context, container, dynamic, and deployment diagrams.
---
